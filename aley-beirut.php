...
"> Cedar</font> Buses</div>
    ...
    <div class="top" onmouseover="displayMap()">
      <table class="table">
        <tr>
          <td class="td" colspan="4"><p class="tableTitle">Aley-Beirut</p></td>
        </tr>
        <tr>
          <th>Trip</th>
          <th>Bus</th>
    ...
    <div class="footer">
      ...
      <div class="card2">
        ...
        <ul type="disc" style="padding-left: 30px;">
          ...
          <li><a class="underlineLink" href="signin.php">Schedules</a></li>
...
<script type="text/javascript">
  ...
  var start = L.marker([33.80739825045499, 35.596919193155465], {icon: pointA, title:"Start Point. Click for more details."}).addTo(map).bindPopup('<b><u>Aley-Beirut</u></b>  <p>Stop No.: Start Point</p> <p>Stop Name: Saraya Aley </p><p>Departure Time: 0</p> <p>Distance to next stop: 7.3km</p> <p>Distance to destination: 17.9km');

  var stop1 = L.marker([33.8292293905731, 35.573224307597116], {icon:busStop}).addTo(map).bindPopup('<b><u>Aley-Beirut</u></b>  <p>Stop No.: 1</p><p>Stop Name: Al Jamhour </p> <p>Departure Time: 15 Minutes</p> <p>Distance to next stop: 5.7km</p> <p>Distance to destination: 10.6km');

  var stop2 = L.marker([33.856538336950564, 35.528098506506794], {icon:busStop}).addTo(map).bindPopup('<b><u>Aley-Beirut</u></b>  <p>Stop No.: 2</p><p>Stop Name: Gallerie Semaan </p> <p>Departure Time: 25 Minutes</p> <p>Distance to next stop: 3.2km</p> <p>Distance to destination: 4.9km');

  var stop3 = L.marker([33.859996237304614, 35.49425712686053], {icon:busStop}).addTo(map).bindPopup('<b><u>Aley-Beirut</u></b>  <p>Stop No.: 3</p><p>Stop Name: Ghobeiri </p> <p>Departure Time: 35 Minutes</p> <p>Distance to next stop: 1.7km</p> <p>Distance to destination: 1.7km');
  var end = L.marker([33.87477790788144, 35.49635323363613], {icon:pointB}).addTo(map).bindPopup('<b><u>Aley-Beirut</u></b>  <p>Stop No.: End Point</p><p>Stop Name: Cola </p> <p>Approx. Arrival Time: 45 Minutes</p> <p>Distance to next stop: N/A</p> <p>Distance to destination: 0.0km');
