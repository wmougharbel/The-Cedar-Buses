...
if(isset($_POST['submit'])){
		...
		do{
			if(empty($route) || empty($trip) || empty($bus) || empty($driver) || empty($time)){
				$errorMessage = "All fields are required";
				break;
			}

			//CREATE TABLE
			$sql= "CREATE TABLE $route (id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, trip VARCHAR(15) NOT NULL, bus VARCHAR(5) NOT NULL, driver VARCHAR(30) NOT NULL, trip_time VARCHAR(5) NOT NULL)"; 
			...
			$sql="INSERT INTO $route (trip, bus, driver, trip_time) VALUES ('$trip','$bus','$driver','$time')";
